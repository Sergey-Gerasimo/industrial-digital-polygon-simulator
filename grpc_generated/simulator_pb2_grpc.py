...
import grpc_generated.simulator_pb2 as simulator__pb2
...
class SimulationDatabaseManager(object):
    ...
    @staticmethod
    def get_available_equipment_types(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def get_available_workplace_types(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def get_available_lean_improvements(
        request,
        target,
        options=(),
        channel_credentials=None,
